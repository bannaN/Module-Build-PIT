...
my $mbp = Module::Build::PIT->new(
  dist_name => 'Human',
  dist_version => '0.01',
  module_name => 'Human',
  tests => 't/Modules/Human-0.01/t'
);
...

{
  ...
  my @expected = (
    {
      from => 't/Modules/Human-0.01/t/00-human.t',
      to => 'blib/lib/auto/tests/Human-0.01/t/Modules/Human-0.01/t/00-human.t'
    },
    {
      from => 't/Modules/Human-0.01/t/moretests/01-human-retest.t',
      to => 'blib/lib/auto/tests/Human-0.01/t/Modules/Human-0.01/t/moretests/01-human-retest.t'
    }
  );
  
  $mbp_mocked->mock('copy_if_modified', sub{
    my ($self, %params) = @_;
